...
class Button:
    ...
    def __init__(self, button_pin):
        self.button = Pin(button_pin[0],Pin.IN)
        self.time=0
        self.dots=0

        self.display = max7219.Matrix8x8(spi, ss, 1)
        self.display.fill(0)
        self.display.show()
    ...
    def button_defuse(self, seed=0):
        ...
        self.button.irq(trigger=Pin.IRQ_FALLING, handler=button_pressed)